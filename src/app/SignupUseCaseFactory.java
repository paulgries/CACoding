...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ...
            ClearViewModel clearViewModel, SignupUserDataAccessInterface signupUserDataAccessObject,
            ClearUserDataAccessInterface clearUserDataAccessObject) {

        try {
            SignupController signupController = createUserSignupUseCase(
                    viewManagerModel, signupViewModel, loginViewModel, signupUserDataAccessObject);
            ClearController clearController = createUserClearUseCase(
                    viewManagerModel, clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(
            ViewManagerModel viewManagerModel, ClearViewModel clearViewModel,
